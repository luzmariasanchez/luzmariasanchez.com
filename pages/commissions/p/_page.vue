<template>
  <div class="w-full container mx-auto">
    ...
    <template v-else>
      ...
      <Pagination :pathName="'commissions-p-page'" :currentPage="+currentPagination" :totalPage="+totalPagination">
      </Pagination>
    </template>
  </div>
</template>
...
export default {
  name: "commissions-p-page",
  nuxtI18n: {
    paths: {
      en: "/commissions/p/:page",
      es: "/comisiones/p/:page",
    },
  },
  head() {
