  ...
  <div class="w-full container mx-auto">
    ...
    <div class="grid md:grid-cols-12 gap-5">
      <div class="md:col-span-9">
        ...
        <Pagination :pathName="'check-residencys'" :currentPage="+currentPagination" :totalPage="+totalPagination">
        </Pagination>
      </div>
      <div class="md:col-span-3 md:pt-0 p-2">
        <CheckMenu current="residencys"></CheckMenu>
      </div>
    </div>
  </div>
</template>
...
import schema from "@/schemas/residencys";
import { extractSlugs } from "@/helpers/extractSlugs";

export default {
  name: "check-residencys",
  nuxtI18n: {
    paths: {
      en: "/check/residencys",
      es: "/check/residencys",
