<template>
  <div class="w-full container mx-auto">
    ...
    <template v-else>
      ...
      <Pagination :pathName="'collections-p-page'" :currentPage="+currentPagination" :totalPage="+totalPagination">
      </Pagination>
    </template>
  </div>
</template>
...
export default {
  name: "collections-p-page",
  nuxtI18n: {
    paths: {
      en: "/collections/p/:page",
      es: "/colecciones/p/:page",
    },
  },
  head() {
